...
<html>
<head>
<title>Kids School a Education School Category Flat Bootstrap Responsive Website Template | Services :: w3layouts</title>
<!-- for-mobile-apps -->
				...
				<div class="services">
					...
					<div class="services-grids">
						<div class="col-md-4 services-grid-left">
							<img src="images/library.jpg" alt=" " class="img-responsive" />
						</div>
						<div class="col-md-8 services-grid-right">
							<h3>We Provide Awesome <span>Services</span></h3>
							<p>In line with its objective of developing the total person of each students, Living Stone Christian Academy High school and Elementary Unit provides an extensive personnel service program and the following services in order to meet the needs and requirements of the students:</p>
							<h4><i>Should you encounter any problem/s or have any complaint/s you may write a letter or talk to the Coordinator for Student Services.</i></h4>
							<div class="services-grid-right-l">
								<p>we will open World of <span>Knowledge</span> for you</p>
							</div>
							<div class="services-grid-right-r">
								<h5>Contact Us <i>+63 (075) 582 2901 </i></h5>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="clearfix"> </div>
					...
					<div class="services-grids1">
						<div class="col-md-3 services-grids1-grid">
							...
							<h4><a href="#.php">LSCA Library</a></h4>
							<p>The Library as a service unit in the school community, is an integral part of the instructional and research programs of the LSCA School Unit.</p>
							<div class="more">
						...
						<div class="col-md-3 services-grids1-grid">
							...
							<h4><a href="#">Audio-Visual Center</a></h4>
							<p>The LSCA Audio-Visual Center is a multi-media center which serves primarily the school unit and other members of the LSCA community.</p>
							<div class="more">
								<a href="#" class="hvr-rectangle-out">Read More...</a>
							</div>
						</div>
						<div class="col-md-3 services-grids1-grid">
							...
							<h4><a href="#">Christian Ministry</a></h4>
							<p>Christian Ministry is carried out by christians to spreading their faith  between the church and the academic community.</p>
							<div class="more">
								<a href="#" class="hvr-rectangle-out">Read More...</a>
							</div>
						</div>
						<div class="col-md-3 services-grids1-grid">
							...
							<h4><a href="single.php">Computer Center</a></h4>
							<p>Computer Center provides the support needed for the delivery of quality instruction.This have to be properly used, maintained and protected.</p>
							<div class="more">
								<a href="#" class="hvr-rectangle-out">Read More...</a>
							</div>
						</div>
