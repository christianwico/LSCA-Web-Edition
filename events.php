						...
						<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
							<nav class="stroke">
								<ul class="nav navbar-nav">
									...
									<li class="active"><a href="events.php">News & Events</a></li>
						...
						<div class="col-md-8 event-left">
							<div class="event-left1">
								<div class="col-xs-6 event-left1-left">
									<a href="#"><img src="images/eve1.jpg" alt=" " class="img-responsive" /></a>
									<div class="event-left1-left-pos">
										<ul>
											...
											<li><a href="#"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> clfsrecto</a></li>
										</ul>
									</div>
								</div>
								<div class="col-xs-6 event-left1-right">
									<h4>29th / Feb 2016</h4>
									<h3><a href="#">23rd NATIONAL STUDENT CONVENTION</a></h3>
									<p align="justify">Full of determination and filled with fervent prayer, the LSCA team pushed the 23rd National Students’ Convention held at Subic Bay Freeport, Subic, Zambales, last October 18, 2015 amidst Typhoon Lando.</p>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="event-left1">
								<div class="col-xs-6 event-left1-right event-left1-right-dummy">
									<h4>1st / Sept 2015</h4>
									<h3><a href="#">BIBLE DISTRIBUTION</a></h3>
									<p>Last September 1, 2015, LSCA students and teachers received a free copy of the New King James Version Bible courtesy of Gideons International.</p>
								</div>
								<div class="col-xs-6 event-left1-left">
									<a href="single.php"><img src="images/eve2.jpg" alt=" " class="img-responsive" /></a>
									<div class="event-left1-left-pos">
										<ul>
											<li><a href="#"><span class="glyphicon glyphicon-tags" aria-hidden="true"></span>5 Tags</a></li>
											<li><a href="#"><span class="glyphicon glyphicon-heart" aria-hidden="true"></span>200 Likes</a></li>
							...
							<div class="event-left1">
								<div class="col-xs-6 event-left1-left">
									<a href="single.php"><img src="images/eve3.jpg" alt=" " class="img-responsive" /></a>
									<div class="event-left1-left-pos">
										<ul>
											<li><a href="#"><span class="glyphicon glyphicon-tags" aria-hidden="true"></span>5 Tags</a></li>
											<li><a href="#"><span class="glyphicon glyphicon-heart" aria-hidden="true"></span>200 Likes</a></li>
								...
								<div class="col-xs-6 event-left1-right">
									...
									<h3><a href="single.php">NUTRITION MONTH COOKFEST</a></h3>
									<p>A special health awareness campaign pursuant to Presidential Decree 491 or the Nutrition Act of the Philippines is celebrated every year in the month of July.</p>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="event-left1">
								<div class="col-xs-6 event-left1-right event-left1-right-dummy">
									<h4>27th / march 2016</h4>
									<h3><a href="single.php">ELEMENTARY & SECONDARY GRADUATES</a></h3>
									<p>L- R: Keith T. Martin, Marilyn Martin, Mareife Buenaventura, Althea Buenaventura, Deborah Praise D. Galvez, Mary Rose D. Galvez, Mike Joshua Casera, Rebecca S. Casera, Bien Clay Parilla, Bienvinido Parilla, Franze Steffi Alvarez, Paris Alvarez, Crisarrah Corral, Ptr. Noel Corral, Aurora S. Zayat, Andrea Joyce Zayat, Ptr. Augusto A. Kho, Mrs. Jorgina P. Reyes</p>
								</div>
								<div class="col-xs-6 event-left1-left">
									<a href="single.php"><img src="images/eve4.jpg" alt=" " class="img-responsive" /></a>
									<div class="event-left1-left-pos">
										<ul>
											<li><a href="#"><span class="glyphicon glyphicon-tags" aria-hidden="true"></span>5 Tags</a></li>
											<li><a href="#"><span class="glyphicon glyphicon-heart" aria-hidden="true"></span>200 Likes</a></li>
