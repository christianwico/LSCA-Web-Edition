...
<html>
<head>
<title>Kids School a Education School Category Flat Bootstrap Responsive Website Template | Mail Us :: w3layouts</title>
<!-- for-mobile-apps -->
				...
				<div class="mail">
					...
					<div class="mail-grids">
							...
							<div class="mail-grid1">
								...
								<div class="col-xs-9 mail-grid-right">
									<div class="mail-grid-right1">
										<h3>Living Stone Christian Academy Recto,Manila <br><i>Philippines</i></h3>
									</div>
								</div>
								<div class="clearfix"> </div>
							</div>
						...
						<div class="col-md-4 mail-grid">
							<div class="mail-grid1">
								...
								<div class="col-xs-9 mail-grid-right">
									<div class="mail-grid-right1">
										<p><a href="mailto:info@example.com">lscarecto@clsf.com</a>
						...
						<div class="col-md-4 mail-grid">
							<div class="mail-grid1">
								...
								<div class="col-xs-9 mail-grid-right">
									<div class="mail-grid-right1">
										<p>+63 (075) 582 2901 <span>+63 (075) 582 7343 (telefax)</span></p>
									</div>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="map-grids">
						<div class="col-md-6 map-grid">
							...
							<iframe src= "https://www.google.com/maps/embed/v1/place?q=Recto,+Manila,+NCR,+Philippines&key=AIzaSyAN0om9mFmy1QN6Wf54tXAowK4eT0ZUPrU"
